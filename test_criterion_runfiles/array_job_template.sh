...
#SBATCH --array=1-15
#SBATCH --job-name=wsqdivflips_imagenette
#SBATCH --output=out_files/densenet_imagenette/array_job%a.out
source activate base
device=0;

param_folder='test_criterion_runfiles/imagenette_densenet_array_args';
