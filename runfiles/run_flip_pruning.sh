...
# LeNet300
CUDA_VISIBLE_DEVICES=0 python main.py -m lenet300 -d mnist -bs 256 -e 100 -lr 1e-3 --prune_criterion flip \
                --flip_threshold 25 --noise --opt rmsprop --reg_type wdecay --lambda 0\
                --anneal_lambda --logdir="test" --comment="test whole dataset to gpu"
# LeNet5
