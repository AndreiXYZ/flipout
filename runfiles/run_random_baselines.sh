...
CUDA_VISIBLE_DEVICES=0 python main.py -m lenet300 -d mnist -bs 256 -e 200 -lr 1e-3 --prune_criterion random \
                --prune_freq 2 --prune_rate 0.2 --opt adam --logdir="test" --comment="lenet300 random"
...
CUDA_VISIBLE_DEVICES=0 python main.py -m resnet18 -d cifar10 -bs 128 -e 350 -lr 0.1 --prune_criterion random \
                --prune_freq 2 --prune_rate 0.2 --opt sgd --momentum 0.9 --reg_type wdecay --lambda 5e-4 --use_scheduler \
                --milestones 150 250 --logdir="test" --comment="resnet18 random"
