...
python main.py -m lenet300 -d mnist -bs 256 -e 100 -lr 1e-3 --prune_criterion snip \
                --snip_sparsity 0.99 --opt adam --logdir="baselines" --comment="lenet300 snip=0.99" \
                --device cuda:1

# LeNet5
python main.py -m lenet5 -d mnist -bs 256 -e 100 -lr 2e-3 --prune_criterion snip \
                --snip_sparsity 0.99 --opt adam --logdir="baselines" --comment="lenet5 snip=0.99" \
                --device cuda:1

# ResNet18
python main.py -m resnet18 -d cifar10 -bs 128 -e 350 -lr 0.1 --prune_criterion snip \
                --snip_sparsity 0.99 --opt sgd --momentum 0.9 --reg_type wdecay --lambda 5e-4 --use_scheduler \
