...
###############################
# TODO VERIFICA SCRIPTUL ASTA FIINDCA NU E CORECT
###############################

# LeNet300
CUDA_VISIBLE_DEVICES=1 python main.py -m lenet300 -d mnist -bs 256 -e 100 -lr 0.1 --prune_criterion flip \
                --flip_threshold 1 --opt rmsprop --reg_type wdecay --lambda 5e-4 \
